...
export const ProductQuerySchema = z.object({
  query: z.object({
    ...
    isOrganic: z.string().optional().transform((val) => (val === undefined ? undefined : val === 'true')),
    isOrganicOnly: z.string().optional().transform((val) => (val === undefined ? undefined : val === 'true')),
    qualityGrade: z.string().optional(),
    minRating: z.string().optional().transform((val) => (val ? parseFloat(val) : undefined)),
    requiresColdChain: z.string().optional().transform((val) => (val === undefined ? undefined : val === 'true')),
